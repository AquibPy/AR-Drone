...
public class GameManager : MonoBehaviour
{
    ...
    {
        public bool _moving;
        public bool _interpolationAsc;
        public bool _interpolationDesc;
        public float _axis;
    ...
    {
        if (_controls._moving || _controls._interpolationAsc || _controls._interpolationDesc)
        {
            if (_controls._interpolationAsc)
            {
                _controls._axis += 0.5f;
                if (_controls._axis >= 1.0f)
                {
                    _controls._axis = 1.0f;
                    _controls._interpolationAsc = false;
                    _controls._interpolationDesc = true;
                }
            }
            else if (!_controls._moving)
            {
                ...
                if (_controls._axis <= 0.0f)
                {
                    ...
                    _controls._interpolationDesc = false;
                }
            }
        }
    }
    ...
    public void EventOnLeftButtonPressed()
    {
        ...
        _MovingLeft._interpolationAsc = true;
    ...
    public void EventOnBackButtonPressed()
    {
        ...
        _MovingBack._interpolationAsc = true;
